...
public class SondaggioSceltaMultipla extends Sondaggio{
	...
	public Post inserisciCaratteristiche(Post p) {
		...
		p = new SondaggioSceltaMultipla(p.getIdPost(), p.getDescrizione(), p.isVisibile(), p.getProfilo(), this.getPrimaScelta(), this.getSecondaScelta(), this.getTerzaScelta(), this.getQuartaScelta());
