...
public MessaggioPrivato(String idMsgPvt, Date dataInvio, Time oraInvio, String testo, String multimedia,
...
public String toString() {
	return "MessaggioPrivato [idMsgPvt=" + idMsgPvt + ", dataInvio=" + dataInvio + ", oraInvio=" + oraInvio + ", testo="
			+ testo + ", multimedia=" + multimedia + ", profiloInviante=" + profiloInviante + ", profiloRicevente="
			+ profiloRicevente + "]";
}
}
