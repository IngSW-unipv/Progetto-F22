...
public class SondaggioMap1Dao implements ISondaggioMap1Dao{

	private Connection conn;
	private String schema;
	public SondaggioMap1Dao() {
		super();
	...
	public boolean carica(String profilo, String sondaggio) {
		...
		try
		{
			String query="insert into sondaggiomap1 (profilo,sondaggio) values (?,?)";
	...
	public ArrayList<String> cerca(String profilo, String sondaggio) {
		...
		try
		{
			String query="SELECT profilo,sondaggio FROM sondaggiomap1 WHERE profilo=? and sondaggio=?";
