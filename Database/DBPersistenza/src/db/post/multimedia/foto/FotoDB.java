...
public class FotoDB extends MultimediaDB{
	public FotoDB(String idPost, Date dataPubblicazione, Time oraPubblicazione, String descrizione, boolean visibile, boolean condivisibile, String profilo,
	...
	public PostDB inserisciCaratteristiche(PostDB p) {
		FotoDB fdb = new FotoDB(p.getIdPost(), p.getDataPubblicazione(), p.getOraPubblicazione(), p.getDescrizione(), p.isVisibile(), p.isCondivisibile(), p.getProfilo(), this.getPercorso(), this.isHd);
		return fdb;
	}
